...
OBJSRC = ./src/main.o ./src/lsdft_initObjs.o  ./src/lsdft_matvec.o  ./src/lsdft_scf.o  ./src/lsdft_readfiles.o ./src/lsdft_tools.o ./src/lsdft_nl.o
...
sq: ${OBJSRC} chkopts
	${CLINKER} -Wall -o ${LIBBASE} ${OBJSRC} ${PETSC_LIB}
	${RM} $(SOURCECPP:%.cc=%.o)
